...
class StaringGameService:
    ...
    async def run_game(self, channel: TextChannel, message_id: int) -> None:
        ...
        while len(survivors) > 1:
            ...
            embed_in_progress = await ui_utils.format_scp173_start_game_embed(
            ...
            if game_state.mode == "normal" and a_death_occurred:
                ...
                if not survivors:
                    ...
                    winner = survivors[0]
                    await economy_management_service.update_user_balance(
                        winner, pot, t("economy.reasons.game_win_staring")
                    )
                    asyncio.create_task(
                        achievement_handler_service.handle_scp173_achievements(
            ...
            if not a_death_occurred:
                round_summary = t("responses.games.staring.round_summary_no_death")
            else:
                round_summary = t("responses.games.staring.round_summary_death")
